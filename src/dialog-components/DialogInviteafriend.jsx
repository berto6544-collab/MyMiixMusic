...
<DialogActions>
        ...
        <DialogTitle>Invite & Connect On MyMiix</DialogTitle> 
       
          <img src={'https://mymiix.com/stripe.jpg'} style={{width:'100%', height:150, objectFit:'cover'}} />
          <DialogContentText style={{color:'black'}}>
           Earn Followers by Inviting & Connecting. share your invite link to others and go to <a href={'https://mymiix.com/account'}>account</a> to see your Monetization criterias.
         </DialogContentText>
        ...
        <div style={{display:'flex',alignItems:'center'}}>
         <FacebookShareButton  url={'https://mymiix.com/invite/'+props.username+''} quote={'SignUp and join the MyMiix Family Today!'} >
