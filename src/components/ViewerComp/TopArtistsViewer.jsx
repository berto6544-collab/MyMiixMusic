...
const contents = dataSource.map((posts,i) => {
  ...
  return(
    <div onClick={()=>{
      window.location.href = '/artist/'+posts.username
    }} className="songRow" >
...
<img className="songRow__album" src={posts?.profileimg} alt="" />
</div>
...
<a style={{textDecoration:'none'}} href={"/explore/TopArtists"} ><b>Show All</b></a>
